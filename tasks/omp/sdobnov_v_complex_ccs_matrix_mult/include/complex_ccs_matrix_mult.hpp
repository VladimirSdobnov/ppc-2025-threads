...
namespace sdobnov_v_complex_ccs_matrix_mult_omp {
...
class OmpComplexCcsMatrixMult : public ppc::core::Task {
 public:
  explicit OmpComplexCcsMatrixMult(std::shared_ptr<ppc::core::TaskData> task_data) : Task(std::move(task_data)) {}
